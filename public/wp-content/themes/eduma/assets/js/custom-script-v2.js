...
var thim_course_menu_landing=function(){if($('.thim-course-menu-landing').length>0){var menu_landing=$('.thim-course-menu-landing'),tab_course=$('#course-landing .nav-tabs')
...
tab_item.on('click',function(){var href=$(this).attr('href'),parent_landing=tab_landing.find('>li>a[href="'+href+
'"]').parent()
...
$(document).ready(function(){$('.course-wishlist-box [class*=\'course-wishlist\']').on('click',function(event){event.preventDefault()
var $this=$(this)
...
'</a></li>'}else{data_li+='<li class="ui-menu-item'+
this['id']+' ob-selected">'+
...
'px')}else{$selector.css('left','-15px')
$selector.css('right','-'+
